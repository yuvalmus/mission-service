...
import { applyRouteWptUpdate, wptEqualsRouteWptDto, wptFromRouteWptDto } from '@mappers/points.mapper';
...
export interface RouteWptService {
  ...
  removeWpts(route: Route, dto: CreateOrUpdateRouteDto, context: TransactionContext): Promise<Route>;
  createWptsForRoute(routeWpts: CreateRouteWptDto[], route: Route, context: TransactionContext): Promise<Route>;
  updateExistingWpt(existingWpt: Wpt, dto: CreateRouteWptDto, route: Route, context: TransactionContext): Promise<void>;
}
